import os
from yt_concate.settings import CAPTIONS_DIR, DOWNLOADS_DIR, OUTPUTS_DIR, VIDEOS_DIR
...
class utils:
    ...
    def caption_file_exists(self, yt):
        ...
        return os.path.exists(yt.caption_filepath) and os.path.getsize(filepath) > 0
